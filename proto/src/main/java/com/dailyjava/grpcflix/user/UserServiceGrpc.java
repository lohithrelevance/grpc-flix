...
public final class UserServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<UserSearchRequest,
      UserResponse> getGetUserGenreMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getUserGenre",
      requestType = UserSearchRequest.class,
      responseType = UserResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<UserSearchRequest,
      UserResponse> getGetUserGenreMethod() {
    io.grpc.MethodDescriptor<UserSearchRequest, UserResponse> getGetUserGenreMethod;
      ...
      synchronized (UserServiceGrpc.class) {
        if ((getGetUserGenreMethod = UserServiceGrpc.getGetUserGenreMethod) == null) {
          UserServiceGrpc.getGetUserGenreMethod = getGetUserGenreMethod = 
              io.grpc.MethodDescriptor.<UserSearchRequest, UserResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "UserService", "getUserGenre"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  UserSearchRequest.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<UserGenreUpdateRequest,
      UserResponse> getUpdateUserGenreMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "updateUserGenre",
      requestType = UserGenreUpdateRequest.class,
      responseType = UserResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<UserGenreUpdateRequest,
      UserResponse> getUpdateUserGenreMethod() {
    io.grpc.MethodDescriptor<UserGenreUpdateRequest, UserResponse> getUpdateUserGenreMethod;
      ...
      synchronized (UserServiceGrpc.class) {
        if ((getUpdateUserGenreMethod = UserServiceGrpc.getUpdateUserGenreMethod) == null) {
          UserServiceGrpc.getUpdateUserGenreMethod = getUpdateUserGenreMethod = 
              io.grpc.MethodDescriptor.<UserGenreUpdateRequest, UserResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "UserService", "updateUserGenre"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  UserGenreUpdateRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  UserResponse.getDefaultInstance()))
  ...
  public static final class UserServiceBlockingStub extends io.grpc.stub.AbstractStub<UserServiceBlockingStub> {
    ...
    /**
     */
    public UserResponse getUserGenre(UserSearchRequest request) {
    ...
    /**
     */
    public UserResponse updateUserGenre(UserGenreUpdateRequest request) {
      return blockingUnaryCall(
  ...
  public static final class UserServiceFutureStub extends io.grpc.stub.AbstractStub<UserServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<UserResponse> getUserGenre(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<UserResponse> updateUserGenre(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_USER_GENRE:
          serviceImpl.getUserGenre((UserSearchRequest) request,
              (io.grpc.stub.StreamObserver<UserResponse>) responseObserver);
          break;
        case METHODID_UPDATE_USER_GENRE:
          serviceImpl.updateUserGenre((UserGenreUpdateRequest) request,
              (io.grpc.stub.StreamObserver<UserResponse>) responseObserver);
          break;
        default:
